...
namespace Functions
{
    class Program
    {
...

        {
            ...
            switch (userOperator)
            {
                ...
                case '/':
                    ...
                    break;
                case '*':
                    KorrutaTwoNumbers(userNumberOne, userNumberTwo);
                    break;
                case '-':
                    LahutaTwoNumbers(userNumberOne, userNumberTwo);
                    break;
                default:
        ...
        public static void KorrutaTwoNumbers (double x, double y)
        ...
        public static void LahutaTwoNumbers(int x, int y)
